<%@ Page Title="" Language="C#" MasterPageFile="~/Website.Master" AutoEventWireup="true" CodeBehind="agregarRolRegistrado.aspx.cs" Inherits="CARA_Draftv0._1.App.Administracion.AgregarRolRegistrado" %>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div id="RolesRegistradoBox" runat="server">
             ...
             <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-5 border-bottom">
                <h1 class="h2">Agregar Usuario al Rol: <asp:Label ID="lblRol" Text="" runat="server" /></h1>
            ...
            <div class="mb-4">
                ...
                <div class="btn-toolbar justify-content-between mb-4" role="toolbar" aria-label="Toolbar with button groups">
                    ...
                    <div id="divBotones" style="padding-top: 10px;">
                        <asp:Button ID="btnAgregarUsuario" runat="server" CssClass="btn btn-outline-secondary" OnClick="btnRolUsuario_Click" Text="Agregar Usuario" />
                    </div>
                </div>
