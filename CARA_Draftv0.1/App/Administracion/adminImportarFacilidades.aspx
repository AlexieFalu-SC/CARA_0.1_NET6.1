<%@ Page Title="" Language="C#" MasterPageFile="~/Website.Master" AutoEventWireup="true" CodeBehind="adminImportarFacilidades.aspx.cs" Inherits="CARA_Draftv0._1.App.Administracion.adminImportarFacilidades" %>
                    ...
                    <div class="col-auto mb-3">
                        <h3 class="page-header-title">
                            <div class="page-header-icon">
                                <i class="fas fa-fw fa-user-edit"></i><span> Importar Nuevas Facilidades a Cuentas Principales Existentes (REGISTRADOS)</span>
                            </div>
                        </h3>
                    </div>
                   <%-- <div class="col-auto">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="text-center">
                                    ...
                                    <div style="text-align:center" class="small font-italic text-muted mb-4"><span>Aqui puede importar nuevas facilidades a cuentas principales existentes, utilizando un documento EXCEL (.xslx). Puede <a href="<%=ResolveClientUrl("~/Documents/ImportarFacilidades_Ejemplo.xlsx")%>"><span>descargar este ejemplo</span></a> , el cual indica el formato del documento el cual debe contener dies (10) columnas con exactamente el formato indicado en el ejemplo.</span></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
