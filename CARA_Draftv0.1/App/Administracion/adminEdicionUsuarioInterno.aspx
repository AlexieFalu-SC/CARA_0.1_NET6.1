<%@ Page Title="" Language="C#" MasterPageFile="~/Website.Master" AutoEventWireup="true" CodeBehind="adminEdicionUsuarioInterno.aspx.cs" Inherits="CARA_Draftv0._1.App.Administracion.adminEdicionUsuarioInterno" %>
                    ...
                    <div class="col-auto mb-3">
                        <h3 class="page-header-title">
                            <div class="page-header-icon">
                                <i class="fas fa-fw fa-user-edit"></i><span> Edición de Usuario Interno (ASSMCA)</span>
                            </div>
                        </h3>
                    </div>
                    <div class="col-auto">
            ...
            <div class=" row">
                <ul class="nav nav-tabs col-xl-12 mb-4" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="true">Información de Usuario Interno</a>
                    </li>
                    <li class="nav-item" role="presentation">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                       ...
                                       <%-- <div class="form-group col-6" runat="server" id="divChkModulos" visible="true">
