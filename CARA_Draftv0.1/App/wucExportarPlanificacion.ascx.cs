...
{
    public partial class wucExportarPlanificacion : System.Web.UI.UserControl
    {
        ...
        private void GetPerfiles()
        {
            ...
            try
            {
                using (CARAEntities dsCARA = new CARAEntities())
                {
                    ...
                    {
                        gvPerfilesDetailList.DataSource = perfilesList;

                        gvPerfilesDetailList.DataBind();

                        gvPerfilesDetailList.UseAccessibleHeader = true;
                        gvPerfilesDetailList.HeaderRow.TableSection = TableRowSection.TableHeader;
                        gvPerfilesDetailList.FooterRow.TableSection = TableRowSection.TableFooter;
                    }
                    else
                    {
                        gvPerfilesDetailList.DataSource = null;
        ...
        protected void ExportToExcel(object sender, EventArgs e)
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                //To Export all pages
                gvPerfilesDetailList.AllowPaging = false;
                //this.BindGrid();

                gvPerfilesDetailList.HeaderRow.BackColor = Color.White;
                ...
                gvPerfilesDetailList.RenderControl(hw);
